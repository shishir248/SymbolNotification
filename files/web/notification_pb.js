...
goog.exportSymbol('proto.notifications.SubscribeRequest', null, global);
/**
 ...
 * @constructor
 */
proto.notifications.SubscribeRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.notifications.SubscribeRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.notifications.SubscribeRequest.displayName = 'proto.notifications.SubscribeRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {string}
 */
proto.notifications.Notification.prototype.getSubscription = function() {
 ...
 */
proto.notifications.Notification.prototype.setSubscription = function(value) {
 ...
 * @return {boolean}
 */
proto.notifications.Notification.prototype.getAccess = function() {
 ...
 * @return {!proto.notifications.Notification} returns this
 */
proto.notifications.Notification.prototype.setAccess = function(value) {
 ...
 * @return {!Object}
 */
proto.notifications.SubscribeRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.notifications.SubscribeRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.notifications.SubscribeRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.notifications.SubscribeRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    subscription: jspb.Message.getFieldWithDefault(msg, 1, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.notifications.SubscribeRequest}
 */
proto.notifications.SubscribeRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.notifications.SubscribeRequest;
  return proto.notifications.SubscribeRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.notifications.SubscribeRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.notifications.SubscribeRequest}
 */
proto.notifications.SubscribeRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.notifications.SubscribeRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.notifications.SubscribeRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.notifications.SubscribeRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.notifications.SubscribeRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSubscription();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.notifications.SubscribeRequest.prototype.getSubscription = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.notifications.SubscribeRequest} returns this
 */
proto.notifications.SubscribeRequest.prototype.setSubscription = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.notifications.SubscribeRequest.prototype.getAccessToken = function() {
 ...
 * @return {!proto.notifications.SubscribeRequest} returns this
 */
proto.notifications.SubscribeRequest.prototype.setAccessToken = function(value) {
